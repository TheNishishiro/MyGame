...
namespace NFramework
{
    class NDrawing
    {
        ...
        public static void Draw(ref SpriteBatch sb,Texture2D texture, Vector2 postion, Color color, float layerDepth)
        {
            sb.Draw(texture, postion, null,  null, null, 0, null, color, SpriteEffects.None, layerDepth);
        }
        public static void Draw(ref SpriteBatch sb, Texture2D texture, Rectangle postion, Color color, float layerDepth)
        {
            sb.Draw(texture, null, postion, null, null, 0, null, color, SpriteEffects.None, layerDepth);
        }
        ...
        public static void DrawText(ref SpriteBatch sb, SpriteFont font, string text, Vector2 position)
        {
        ...
        public static void FPS_Draw(Vector2 Position, Color TextColor, GameTime gameTime, SpriteFont font, ref SpriteBatch sb)
        {
            frameCounter++;
            ...
            DrawText(ref sb, font, "FPS: " + frameRate, Position);
        }
